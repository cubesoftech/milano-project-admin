...
function FAQ() {
    const faqs: { question: string, answer: string }[] = [
        ...
        { question: "Monster Lab 마이닝에 대해", answer: "Monster Lab은 ERC 체인 노드 혼잡 및 고가의 가스 수수료 문제를 해결하고 더 많은 사람들이 USDT를 소유하도록 장려하기 위해 이더리움 재단과 테더가 공동으로 시작했습니다.  스마트 계약을 통해 자동으로 유동성 공급자에게 보상을 분배하는 Defi 프로젝트입니다." },
    ]
